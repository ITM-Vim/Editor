...
" Formatting {
    ...
    autocmd FileType c,cpp,java,go,php,javascript,puppet,python,rust,twig,xml,yml,perl,sql autocmd BufWritePre <buffer> if !exists('g:ITM_VIM_keep_trailing_whitespace') | call StripTrailingWhitespace() | endif
